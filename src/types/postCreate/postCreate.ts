...
export enum JobCategory {
  ...
  CUSTOMER_SERVICE_RESEARCH_SALES = 'CUSTOMER_SERVICE_RESEARCH_SALES',
  PRODUCTION_CONSTRUCTION_LABOR = 'PRODUCTION_CONSTRUCTION_LABOR',
  IT_TECHNOLOGY = 'IT_TECHNOLOGY',
  DESIGN = 'DESIGN',
  MEDIA = 'MEDIA',
  DRIVING_DELIVERY = 'DRIVING_DELIVERY',
  HOSPITAL_NURSING_RESEARCH = 'HOSPITAL_NURSING_RESEARCH',
  EDUCATION_INSTRUCTOR = 'EDUCATION_INSTRUCTOR',
}
