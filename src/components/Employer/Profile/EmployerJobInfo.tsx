    ...
    <>
      {jobData && (
        <div className="flex gap-4 items-center justify-center p-4 bg-white rounded-md">
          <div className="flex flex-col justify-between w-full h-[4.25rem] p-3 bg-[#F4F4F9] rounded-md">
          ...
          <div className="flex flex-col justify-between gap-3 w-full h-[4.25rem] p-3 bg-[#F4F4F9] rounded-md">
