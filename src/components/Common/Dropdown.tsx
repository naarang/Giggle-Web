...
export const DropdownModal = ({
  ...
  return (
    <div className="w-full relative shadow rounded-lg bg-white border border-[#dcdcdc] flex flex-row items-start justify-start p-2 text-left body-2 text-[#656565] z-10">
