  ...
  const getButtonStyle = () => {
    switch (type) {
      case buttonTypeKeys.LARGE:
        return 'w-full py-4 flex justify-center items-center rounded-lg button-1';
      case buttonTypeKeys.SMALL:
        return 'w-[24vw] py-3 flex justify-center items-center rounded button-2';
      case buttonTypeKeys.APPLY:
        return `w-full py-4 flex justify-center items-center rounded-lg bg-[#191919] bg-cover bg-center button-1 text-[#F4F4F9]`;
      case buttonTypeKeys.SMALLAPPLY: // 스크랩 버튼과 함께 쓰이는 Apply 버튼
        return `w-[71vw] py-4 flex justify-center items-center rounded-lg bg-[#191919] bg-cover bg-center button-1 text-[#F4F4F9]`;
      case buttonTypeKeys.BACK: // CONTINUE 버튼과 같은 열에 사용
        return 'w-[31vw] py-4 flex justify-center items-center rounded-lg button-1';
      case buttonTypeKeys.CONTINUE: // BACK 버튼과 같은 열에 사용
        return 'w-[53vw] py-4 flex justify-center items-center rounded-lg button-1';
