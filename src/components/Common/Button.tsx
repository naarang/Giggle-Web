  ...
  const getButtonStyle = () => {
    switch (type) {
      case buttonTypeKeys.LARGE:
        return 'w-full py-4 flex justify-center items-center rounded-[2rem] button-1';
      ...
      case buttonTypeKeys.APPLY:
        return `w-full py-4 flex justify-center items-center rounded-[2rem] bg-[url("/src/assets/images/applyButton.jpeg")] bg-cover bg-center button-1 text-[#F4F4F9]`;
